          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Telegram"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#1a1a1a] border border-[rgba(255,255,255,0.08)] text-[#666] hover:text-[#00bfff] hover:border-[rgba(0,191,255,0.3)] transition-colors duration-200"
              >
            ...
            <ul className="space-y-2">
              {FOOTER_NAV.map(({ label, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-[#666] hover:text-[#00bfff] transition-colors duration-200"
                  >
                    {label}
                  </Link>
                </li>
