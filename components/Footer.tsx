      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Telegram"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#1a1a1a] border border-[rgba(255,255,255,0.08)] text-[#666] hover:text-[#7b5cf5] hover:border-[rgba(123,92,245,0.3)] transition-colors duration-200"
              >
            ...
            <ul className="space-y-2">
              {FOOTER_NAV.map(({ label, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-[#666] hover:text-[#7b5cf5] transition-colors duration-200"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            {status === 'success' ? (
              <p className="text-sm text-[#7b5cf5] font-semibold">
                ✓ You&apos;re subscribed!
              </p>
            ) : (
